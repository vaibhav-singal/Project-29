...
function setup() {
    ...
    block24 = new Box(930,275,30,50);
    block25 = new Box(960,275,30,50);
    block26 = new Box(990,275,30,50);
    block27 = new Box(1020,275,30,50);
    block28 = new Box(1050,275,30,50);
    block29 = new Box(960,225,30,50);
    block30 = new Box(990,225,30,50);
    block31 = new Box(1020,225,30,50);
  block32 = new Box(990,175,30,50);
...
ball = Bodies.circle(150,350,50,ball_options);
